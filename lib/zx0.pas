...
* ZX0 decompressor
*
* zx0.exe -f input_filename output_filename    -> procedure unZX0(inputPointer, ZX0_OUTPUT: pointer);		(V2)
*
* zx0.exe -f -c input_filename output_filename -> procedure unZX0C(inputPointer, ZX0_OUTPUT: pointer);		CLASSIC FILE FORMAT (V1)
* zx0.exe -f -c input_filename output_filename -> procedure unZX0(fnam: PString; outputPointer: pointer);	CLASSIC FILE FORMAT (V1)
*
...
interface
	...
	procedure unZX0C(inputPointer, outputPointer: pointer); assembler; register; overload;	// zx0 -c CLASSIC FILE FORMAT
	procedure unZX0C(fnam: PString; outputPointer: pointer); register; overload;		// zx0 -c CLASSIC FILE FORMAT

	procedure unZX0(inputPointer, ZX0_OUTPUT: pointer); assembler; register;		// V2

implementation



procedure unZX0C(fnam: PString; outputPointer: pointer); register; overload;
(*
@description:
...
procedure unZX0C(inputPointer, outputPointer: pointer); assembler; register; overload;
(*
@description:
...
procedure unZX0(inputPointer, ZX0_OUTPUT: pointer); assembler; register;
(*
@description:
ZX0 decompressor (Einar Saukas, Krzysztof 'XXL' Dudek)
FORMAT V2 !!! (last update: 10/10/21)

zx0 inputfile outputfile
