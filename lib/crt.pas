...
{$IFDEF X16}
  ...
  X16_COLOR_WHITE             = PETSCII_COLOR_WHITE;
  X16_COLOR_RED               = PETSCII_COLOR_RED;
  X16_COLOR_GREEN             = PETSCII_COLOR_GREEN;
  X16_COLOR_BLUE              = PETSCII_COLOR_BLUE;
  X16_COLOR_ORANGE            = PETSCII_COLOR_ORANGE;
  X16_COLOR_BLACK             = PETSCII_COLOR_BLACK;
  X16_COLOR_BROWN             = PETSCII_COLOR_BROWN;
  X16_COLOR_PINK              = PETSCII_COLOR_PINK;
  X16_COLOR_DARK_GREY         = PETSCII_COLOR_DARK_GREY;
  X16_COLOR_GREY              = PETSCII_COLOR_GREY;
  X16_COLOR_LIGHT_GREEN       = PETSCII_COLOR_LIGHT_GREEN;
  X16_COLOR_LIGHT_BLUE        = PETSCII_COLOR_BLUE;
  X16_COLOR_LIGHT_GREY        = PETSCII_COLOR_LIGHT_GREY;
  X16_COLOR_PURPLE            = PETSCII_COLOR_PURPLE;
  X16_COLOR_YELLOW            = PETSCII_COLOR_YELLOW;
  X16_COLOR_CYAN              = PETSCII_COLOR_CYAN;
