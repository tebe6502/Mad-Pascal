...
dl_start
    ...
    dta DL_BLANK8 
    dta DL_MODE_40x24T2 + DL_LMS, a(SCREEN_BASE)
    :16 dta DL_MODE_40x24T2 ; remaining 16 lines
    dta DL_MODE_320x192G2
    dta DL_BLANK4       
    dta DL_MODE_40x24T2 + DL_LMS, a(SCREEN_BASE + 40 * 18)
    :3 dta DL_BLANK1, DL_MODE_40x24T2 ; stats
    dta DL_BLANK8        
    dta DL_MODE_40x24T2
    dta DL_BLANK2
    dta DL_MODE_40x24T2
