...
uses atari, sprites12x8, joystick;
...
//  if tim and 3 = 0 then begin
   ...
   sprite2.bitmaps:=sprite0.bitmaps+8;
   sprite3.bitmaps:=sprite0.bitmaps+12;
...
//  if (sprite0.y < 4) or (sprite0.y > 24*8+24) then sprite0.ady:=-sprite0.ady;
  ...
  sprite1.y := sprite0.y+8;
  sprite2.y := sprite0.y+16;
  sprite3.y := sprite0.y+24;
...
begin
 ...
 sprite2.bitmaps:=@spr_stand[4];
 sprite3.bitmaps:=@spr_stand[6];
end;
