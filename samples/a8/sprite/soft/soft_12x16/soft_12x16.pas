...
const
	...
	shp4_r = shp3 + SprSize*2;
	shp4_l = shp4_r + SprSize*2;

	shp5 = shp4_l + SprSize*2;
	shp6 = shp5 + SprSize*2;
	shp7 = shp6 + SprSize*2;
	shp8 = shp7 + SprSize*2;
	...
	spr_stand_r: array of word = [shp4_r, 0, shp4_r+SprSize, 0];
	spr_stand_l: array of word = [shp4_l, 0, shp4_l+SprSize, 0];
...
begin
 ...
 if left then begin
  sprite0.bitmaps:=@spr_stand_l;
  sprite1.bitmaps:=@spr_stand_l[2];
 end else begin
  sprite0.bitmaps:=@spr_stand_r;
  sprite1.bitmaps:=@spr_stand_r[2];
 end;
...

{
 ...
 while true do begin
  ...
  case joy of
   joy_right: begin walk:=@walk_r; left:=false; sprite0.adx:=1; moveSprite end;
    joy_left: begin walk:=@walk_l; left:=true;  sprite0.adx:=-1; moveSprite end;
