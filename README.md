...
### [Simple game tutorial](https://github.com/zbyti/a8-mp-simple-game-tutorial)

### [FiDL](https://gitlab.com/bocianu/fidl)

Display List program editor for 8-bit Atari ANTIC chipse

### [CutAs](https://gitlab.com/bocianu/cutas)

Simple binary data manipulation tool written in javascript
