...
**MP** is not a port of **FPC**; it has been written based on of **SUB-Pascal** (2009), **XD-Pascal** (2010), the author of which is [Vasiliy Tereshkov]([mailto:vtereshkov@mail.ru](https://github.com/vtereshkov)).
