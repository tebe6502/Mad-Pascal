...
; 1chn digi (MD1) 18.08.2025
; wersja MONO, dla STEREO koniec utworu zaczyna drugi POKEY grać "śmieci"
...
adrtrl dta b(0,0,0,0)
adrtrh dta b(0,0,0,0)
maxptr dta b(0)
tempo  dta b(0)

branch dta b(0,0,0,0)
volume dta b(0,0,0,0)
adcvol dta b(0,0,0,0)
freq   dta b(0,0,0,0)
frqwsk dta b(0,0,0,0)
adcdzw dta b(0,0,0,0)
poddzw dta b(0,0,0,0)
adrinl dta b(0,0,0,0)
adrinh dta b(0,0,0,0)
numdzw dta b(0,0,0,0)
numsmp dta b(0,0,0,0)
numptr dta b(0,0,0,0)
ptrwsk dta b(0,0,0,0)
ilespc dta b(0,0,0,0)
licspc dta b(0,0,0,0)
p1lsb  dta b(0,0,0,0)
p1lic  dta b(0,0,0,0)
p1pom  dta b(0,0,0,0)
p2lic  dta b(0,0,0,0)
