...
uses SysUtils, Common, CompilerTypes, Messages, Optimize, SplitString;
...
end;  //TokenizeProgramInitialization
...
function GetStandardToken(const a: TString): Integer;
var
  i: Integer;
  S: TString;
begin
