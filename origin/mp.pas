    ...
    begin
      for IdentIndex := NumIdent downto 1 do
        if (Ident[IdentIndex].Kind in [PROCEDURETOK, FUNCTIONTOK, CONSTRUCTORTOK, DESTRUCTORTOK]) and
          (Ident[IdentIndex].UnitIndex = Ident[ProcIdentIndex].UnitIndex) and (S = Ident[IdentIndex].Name) and
        ...
        begin
          ...
          for i := 1 to NumParams do
            if ((((Ident[IdentIndex].Param[i].DataType in UnsignedOrdinalTypes) and
              (Param[i].DataType in UnsignedOrdinalTypes)) and (DataSize[Ident[IdentIndex].Param[i].DataType] >=
              DataSize[Param[i].DataType])) or (((Ident[IdentIndex].Param[i].DataType in SignedOrdinalTypes) and
              (Param[i].DataType in SignedOrdinalTypes)) and (DataSize[Ident[IdentIndex].Param[i].DataType] >=
              DataSize[Param[i].DataType])) or (((Ident[IdentIndex].Param[i].DataType in SignedOrdinalTypes) and
              ...
              ((Ident[IdentIndex].Param[i].DataType =
              Param[i].DataType) {and (Ident[IdentIndex].Param[i].AllocElementType = Param[i].AllocElementType)})) or
              ...
              ((Param[i].DataType in Pointers) and (Ident[IdentIndex].Param[i].DataType = Param[i].AllocElementType)) or
              // dla parametru VAR

              ((Ident[IdentIndex].Param[i].DataType = UNTYPETOK) and
              (Ident[IdentIndex].Param[i].PassMethod = VARPASSING)) //or
              ...
              begin
                ...
                case Param[i].AllocElementType of
                  ...
                  PROCEDURETOK, FUNCTIONTOK:
                    yes := Ident[GetIdent('@FN' + IntToHex(Ident[IdentIndex].Param[i].NumAllocElements shr 16, 4))].NumParams =
                      Ident[GetIdent(Param[i].Name)].NumParams;

                  PROCVARTOK:
                    yes := (Ident[GetIdent('@FN' + IntToHex(Ident[IdentIndex].Param[i].NumAllocElements shr 16, 4))].NumParams) =
                      (Ident[GetIdent('@FN' + IntToHex(Param[i].NumAllocElements shr 16, 4))].NumParams);
...
writeln('_C: ', Ident[IdentIndex].Name);
     ...
     writeln (Ident[IdentIndex].Param[i].NumAllocElements,',', Param[i].NumAllocElements);
              ...
              if (Ident[IdentIndex].Param[i].DataType = UNTYPETOK) and (Param[i].DataType = POINTERTOK) and
                (Ident[IdentIndex].Param[i].AllocElementType = UNTYPETOK) and (Param[i].AllocElementType <> UNTYPETOK) and
                (Param[i].NumAllocElements > 0) {and (Ident[IdentIndex].Param[i].NumAllocElements = Param[i].NumAllocElements)} then
              begin
{
            ...
            begin
              ...
              begin
                ...
                if (Ident[IdentIndex].Param[m].DataType = l[k].Param[m].DataType) and
                  (Ident[IdentIndex].Param[m].AllocElementType = PROCVARTOK) and (l[k].Param[m].AllocElementType = PROCVARTOK) and
...
*)
  ...
  begin
    ...
    case IndirectionLevel of
      ...
      begin
        ...
        if (Ident[IdentIndex].isAbsolute) and (Ident[IdentIndex].PassMethod <> VARPASSING) and (NumAllocElements = 0) then
          asm65('+' + svar);  // +lda
        ...
        begin
          ...
          if (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType <> UNTYPETOK) and
            (Ident[IdentIndex].PassMethod <> VARPASSING) then
            asm65(#9'mwy ' + svar + ' :bp2')
          else
          ...
          2: begin                    // PUSH WORD
            ...
            begin
              ...
              begin
                ...
                if (Ident[IdentIndex].isAbsolute) and (Ident[IdentIndex].idType = ARRAYTOK) and
  ...
  procedure GenerateIncDec(IndirectionLevel: TIndirectionLevel; ExpressionType: Byte; Down: Boolean;
    IdentIndex: Integer);
  var
        ...
        case DataSize[ExpressionType] of
          1: begin
            ...
            begin
              ...
              if (IdentIndex > 0) and (Ident[IdentIndex].isAbsolute) and (Ident[IdentIndex].idType = ARRAYTOK) and
                (Ident[IdentIndex].Value >= 0) then
              begin
    ...
    begin
      ...
      if ParamY <> '' then
        ...
        begin
          ...
          if (Ident[IdentIndex].DataType = POINTERTOK) and not (Ident[IdentIndex].AllocElementType in
...
{$i targets/generate_program_prolog.inc}
  ...
  procedure GenerateRelationString(relation: Byte; LeftValType, RightValType: Byte; sLeft: Wordbool = False;
    sRight: Wordbool = False);
  begin
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if not (Ident[IdentIndex].Kind in [CONSTANT, VARIABLE, PROCEDURETOK, FUNCTIONTOK, CONSTRUCTORTOK,
            DESTRUCTORTOK, ADDRESSTOK]) then
          ...
          begin
            ...
            begin
              ...
              if (Tok[i + 2].Kind = OBRACKETTOK) and (Ident[IdentIndex].DataType in Pointers) and
                ((Ident[IdentIndex].NumAllocElements > 0) or ((Ident[IdentIndex].NumAllocElements = 0) and
                (Ident[IdentIndex].AllocElementType <> UNTYPETOK))) then
              begin                  // array index
                Inc(i);
                ...
                begin              // record.array[]
                  ...
                  if (Ident[IdentIndex].PassMethod = VARPASSING) or (NumAllocElements * DataSize[AllocElementType] > 256) or
                    (NumAllocElements in [0, 1]) then
                  begin
                ...
                if (Ident[IdentIndex].DataType in [FILETOK, TEXTFILETOK, RECORDTOK, OBJECTTOK] {+ Pointers}) or
                  ((Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].AllocElementType <> 0) and
                  (Ident[IdentIndex].NumAllocElements > 0)) or (Ident[IdentIndex].PassMethod = VARPASSING) or
                ...
                begin
                  ...
                  if (Ident[IdentIndex].PassMethod = VARPASSING) and (Ident[IdentIndex].NumAllocElements > 0) and
                    (Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].AllocElementType in Pointers) and
                    ...
                    begin
                      ...
                      begin
                        ...
                        if (Ident[IdentIndex].DataType in [RECORDTOK, OBJECTTOK, FILETOK, TEXTFILETOK]) or
                          (VarPass and (Ident[IdentIndex].DataType = POINTERTOK) and
                          (Ident[IdentIndex].AllocElementType in AllTypes - [PROCVARTOK, RECORDTOK, OBJECTTOK]) and
                          (Ident[IdentIndex].NumAllocElements = 0)) or ((Ident[IdentIndex].DataType in Pointers) and
                          (Ident[IdentIndex].AllocElementType in [RECORDTOK, OBJECTTOK]) and
                          (VarPass or (Ident[IdentIndex].PassMethod = VARPASSING))) or (Ident[IdentIndex].isAbsolute and
                          (abs(Ident[IdentIndex].Value) and $ff = 0) and (Byte(abs(Ident[IdentIndex].Value shr 24) and $7f) in [1..127])) or
                          ((Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].AllocElementType in
                          [RECORDTOK, OBJECTTOK]) and (Ident[IdentIndex].NumAllocElements_ = 0)) or
                          ((Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].idType = DATAORIGINOFFSET)) or
                          ((Ident[IdentIndex].DataType in Pointers) and not (Ident[IdentIndex].AllocElementType in
                          [UNTYPETOK, RECORDTOK, OBJECTTOK, PROCVARTOK]) and (Ident[IdentIndex].NumAllocElements > 0)) or
                          ((Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].PassMethod = VARPASSING)) then
                          Push(Ident[IdentIndex].Value, ASPOINTER, DataSize[POINTERTOK], IdentIndex)
                        else
  ...
  begin
    ...
    for ParamIndex := Ident[IdentIndex].NumParams downto 1 do
      if not ((Ident[IdentIndex].Param[ParamIndex].PassMethod = VARPASSING) or
        ...
        ((Ident[IdentIndex].Param[ParamIndex].DataType in Pointers) and
        (Ident[IdentIndex].Param[ParamIndex].AllocElementType in [RECORDTOK, OBJECTTOK])) or
      ...
      if (Tok[i + 2].Kind = CPARTOK) then
        ...
        begin
          ...
          begin
            ...
            if (Ident[IdentIndex].Param[NumActualParams].DataType <> UNTYPETOK) and (ActualParamType = POINTERTOK) and
              (AllocElementType in [POINTERTOK, STRINGPOINTERTOK, PCHARTOK]) then
            begin
            ...
            begin
              ...
              if Ident[IdentTemp].DataType in Pointers then
                if not (Ident[IdentIndex].Param[NumActualParams].DataType in [FILETOK, TEXTFILETOK]) then
                begin
 ...
 writeln(Ident[IdentIndex].Param[NumActualParams].PassMethod,',', Ident[IdentTemp].PassMethod);
                  ...
                  if Ident[IdentTemp].PassMethod <> VARPASSING then
                    ...
                    if Ident[IdentIndex].Param[NumActualParams].DataType in [RECORDTOK, OBJECTTOK] then
                      Error(i, 'Incompatible types: got "' + Types[Ident[IdentTemp].NumAllocElements].Field[0].Name
                        + '" expected "^' + Types[Ident[IdentIndex].Param[NumActualParams].NumAllocElements].Field[0].Name + '"')
                    else
...

{
 ...
 writeln(Ident[IdentIndex].Param[NumActualParams].PassMethod,',', Ident[IdentTemp].PassMethod);
                      ...
                      begin
                        ...
                        iError(i, IncompatibleTypes, 0, Ident[IdentTemp].AllocElementType,
            ...
            if IdentTemp = 0 then
              if (Ident[IdentIndex].Param[NumActualParams].DataType = RECORDTOK) and (ActualParamType = POINTERTOK) and
                (AllocElementType = RECORDTOK) then
          ...
          begin
            ...
            if (Ident[IdentIndex].Param[NumActualParams].DataType = POINTERTOK) and
              (Ident[IdentIndex].Param[NumActualParams].NumAllocElements > 0) and not
              (Ident[IdentIndex].Param[NumActualParams].AllocElementType in [RECORDTOK, OBJECTTOK]) then
              i := CompileAddress(i + 1, ActualParamType, AllocElementType)
            else
              i := CompileExpression(i + 2, ActualParamType, Ident[IdentIndex].Param[NumActualParams].DataType);
            // Evaluate actual parameters and push them onto the stack
            ...
            if (Ident[IdentIndex].Param[NumActualParams].DataType in IntegerTypes + RealTypes) and
            ...
            begin
              ...
              if Types[Ident[IdentTemp].NumAllocElements].Field[0].Name <>
                Types[Ident[IdentIndex].Param[NumActualParams].NumAllocElements].Field[0].Name then
                Error(i, 'Incompatible types: got "' + Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "' +
                  Types[Ident[IdentIndex].Param[NumActualParams].NumAllocElements].Field[0].Name + '"');
            ...
            if (Tok[i].Kind = IDENTTOK) and (ActualParamType in [RECORDTOK, OBJECTTOK]) and not
              (Ident[IdentIndex].Param[NumActualParams].DataType in Pointers) then
              if Ident[GetIdent(Tok[i].Name^)].isNestedFunction then
              begin

                if Ident[GetIdent(Tok[i].Name^)].NestedFunctionNumAllocElements <>
            ...
            if ((ActualParamType in [RECORDTOK, OBJECTTOK]) and (Ident[IdentIndex].Param[NumActualParams].DataType in
              Pointers)) or ((ActualParamType in Pointers) and (Ident[IdentIndex].Param[NumActualParams].DataType in
 ...
 writeln(Ident[IdentIndex].Param[NumActualParams].PassMethod,',', Ident[IdentTemp].PassMethod);
            ...
            begin
              ...
              begin
                ...
                if (Ident[IdentIndex].Param[NumActualParams].DataType in [POINTERTOK, STRINGPOINTERTOK]) and
                  (Tok[i].Kind = IDENTTOK) then
                begin
                  IdentTemp := GetIdent(Tok[i].Name^);
                  ...
                  if (Ident[IdentTemp].DataType = STRINGPOINTERTOK) and (Ident[IdentTemp].NumAllocElements <> 0) and
                    ...
                    if Ident[IdentIndex].Param[NumActualParams].AllocElementType = UNTYPETOK then
                      ...
                      if Ident[IdentIndex].Param[NumActualParams].AllocElementType <> BYTETOK then
                        ...
                        iError(i, IncompatibleTypes, 0, Ident[IdentTemp].DataType,
                          -Ident[IdentIndex].Param[NumActualParams].AllocElementType);
      ...
      asm65(#9'adc #$00');
            asm65(#9'sta :STACKORIGIN+STACKWIDTH,x');
                ...
                begin
                  ...
                  if (ActualParamType = POINTERTOK) and (Ident[IdentIndex].Param[NumActualParams].DataType =
    ...
    begin
      ...
      if (Ident[IdentIndex].Block > 1) and (Ident[IdentIndex].Block <> BlockStack[BlockStackTop]) then  // issue #102 fixed
        for IdentTemp := NumIdent downto 1 do
          if (Ident[IdentTemp].Kind in [PROCEDURETOK, FUNCTIONTOK]) and
...

{
  if Ident[IdentIndex].UnitIndex > 1 then
   ...
   asm65(#9'.LOCAL +MAIN.' + svar);                  // w tym samym module poza aktualnym blokiem procedury/funkcji
    ...
    if (Ident[IdentIndex].Kind = FUNCTIONTOK) and (Ident[IdentIndex].isStdCall = False) and
              ...
              begin
                ...
                begin          // length(CHAR) = 1
                  ...
                  begin
                    ...
                    if (Ident[IdentIndex].DataType = STRINGPOINTERTOK) or ((Ident[IdentIndex].DataType in Pointers) and
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin    // length(array[x])
                          ...
                          if (Ident[IdentIndex].NumAllocElements * 2 > 256) or (Ident[IdentIndex].NumAllocElements in [0, 1]) or
                            (Ident[IdentIndex].PassMethod = VARPASSING) then
                          begin
                          ...
                          if (Ident[IdentIndex].PassMethod = VARPASSING) or (Ident[IdentIndex].NumAllocElements = 0) then
                          begin
                            a65(__addBX);
        ...
        if IdentIndex > 0 then
          ...
          begin
            ...
            begin
              ...
              if ((ValType = POINTERTOK) and (Ident[IdentIndex].AllocElementType in OrdinalTypes + RealTypes +
                [RECORDTOK, OBJECTTOK])) or ((ValType = POINTERTOK) and (Ident[IdentIndex].DataType in
                [RECORDTOK, OBJECTTOK])) then
              begin
                ...
                if (Ident[IdentIndex].AllocElementType in [RECORDTOK, OBJECTTOK]) or
                  (Ident[IdentIndex].DataType in [RECORDTOK, OBJECTTOK]) then
                begin
                ...
                begin
                        ...
                        begin            // record^.
                          ...
                          begin
                            ...
                            begin    // record^.label[x]
                              ...
                              Push(Ident[IdentIndex].Value, ASPOINTERTORECORDARRAYORIGIN, DataSize[ValType], IdentIndex,
                                IdentTemp and $ffff);
                  ...
                  // -----------------------------------------------------------------------------
                    ...
                    if Tok[i + 1].Kind = OBRACKETTOK then      // Array element access
                      ...
                      {or ((Ident[IdentIndex].NumAllocElements = 0) and (Ident[IdentIndex].idType <> PCHARTOK))} then  // PByte, PWord
                        iError(i, IncompatibleTypeOf, IdentIndex)
                      else
                      begin
                        ...
                        begin
                          ...
                          begin
                            ...
                            if (Tok[i + 2].Kind = DOTTOK) and (ValType in [RECORDTOK, OBJECTTOK]) then
                            begin
                              ...
                              begin    // array_of_record_pointers[x].array[i]
                                ...
                                if (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType in
                                  [RECORDTOK, OBJECTTOK]) then
                                begin
       ...
       GenerateBinaryOperation(PLUSTOK, WORDTOK);
                              ...
                              begin
                                ...
                                begin         // record_ptr.field[index]
                                  ...
                                  if (Ident[IdentTemp].DataType = POINTERTOK) and (Ident[IdentTemp].AllocElementType in
                                    [RECORDTOK, OBJECTTOK]) then
                                  begin
      ...
      begin
        ...
        begin
          ...
          if (Ident[IdentIndex].DataType in Pointers) and ((Ident[IdentIndex].NumAllocElements > 0) and
            (Ident[IdentIndex].AllocElementType <> RECORDTOK)) then
            if ((Ident[IdentIndex].AllocElementType <> UNTYPETOK) and (Ident[IdentIndex].NumAllocElements in [0, 1])) or
              (Ident[IdentIndex].DataType = STRINGPOINTERTOK) then
  ...
  begin
    ...
    begin
      ...
      begin        // dla PLUSTOK, MINUSTOK rozszerz typ wyniku
        ...
        if (Tok[j + 1].Kind = MINUSTOK) and (RightValType in UnsignedOrdinalTypes) and
    ...
    begin
      ...
      if (Tok[i + 2].Kind = STRINGLITERALTOK) or (RightValType = STRINGPOINTERTOK) then sRight := Wordbool(1)
        ...
        if (RightValType in Pointers) and (Tok[i + 2].Kind = IDENTTOK) then
          if (Ident[GetIdent(Tok[i + 2].Name^)].AllocElementType = CHARTOK) and
            (Elements(GetIdent(Tok[i + 2].Name^)) in [1..255]) then
  ...
  begin
    ...
    case Tok[i].Kind of
      ...
      begin
        ...
        if (IdentIndex > 0) and (Ident[IdentIndex].Kind = FUNCTIONTOK) and (BlockStackTop > 1) and
          (Tok[i + 1].Kind <> OPARTOK) then
        ...
        if IdentIndex > 0 then
          ...
          case Ident[IdentIndex].Kind of
            ...
            begin
              ...
              if (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType = PROCVARTOK) and
                (not (Tok[i + 1].Kind in [ASSIGNTOK, OBRACKETTOK])) then
              begin
              ...
              begin
                ...
                if (Ident[IdentTemp].NumAllocElements_ > 0) and (Ident[IdentTemp].DataType = POINTERTOK) and
                ...
                if DataSize[VarType] <> Elements(IdentIndex) * DataSize[Ident[IdentIndex].AllocElementType] then
                  if VarType = UNTYPETOK then
                    Error(j + 2, 'Illegal type conversion: "POINTER" to "Array[0..' +
                      IntToStr(Elements(IdentIndex) - 1) + '] Of ' + InfoAboutToken(Ident[IdentIndex].AllocElementType) + '"')
                  else
                    if Elements(GetIdent(Tok[j + 2].Name^)) = 0 then
                      Error(j + 2, 'Illegal type conversion: "' + InfoAboutToken(VarType) + '" to "' +
                        Ident[IdentIndex].Name + '"')
                    else
                      Error(j + 2, 'Illegal type conversion: "Array[0..' +
                        IntToStr(Elements(GetIdent(Tok[j + 2].Name^)) - 1) + '] Of ' + InfoAboutToken(VarType) +
                        '" to "' + Ident[IdentIndex].Name + '"');
              ...
              if (Ident[IdentIndex].DataType = PCHARTOK) and
                ...
                (IndirectionLevel = ASPOINTER) and (Tok[i + 2].Kind in [STRINGLITERALTOK,
...
{$i include/compile_pchar.inc}
                ...
                if (Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].AllocElementType = CHARTOK) and
                  (Ident[IdentIndex].NumAllocElements > 0) and ((IndirectionLevel in [ASPOINTER, ASPOINTERTOPOINTER]) or
                ...
                begin                // Usual assignment
                  ...
                  if VarType <> ExpressionType then
                    if (ExpressionType = POINTERTOK) and (Tok[k].Kind = IDENTTOK) then
                      if (Ident[GetIdent(Tok[k].Name^)].DataType = POINTERTOK) and
                        (Ident[GetIdent(Tok[k].Name^)].AllocElementType = PROCVARTOK) then
                      begin
                  ...
                  begin
                    ...
                    if (ExpressionType = CHARTOK) and (Ident[IdentIndex].DataType = POINTERTOK) and
                      (Ident[IdentIndex].AllocElementType = STRINGPOINTERTOK) then
         ...
         if (Elements(IdentTemp) > 0) and (Tok[i + 3].Kind <> OBRACKETTOK) then
          iError(k, IncompatibleTypesArray, IdentTemp, ExpressionType )
                        ...
                        // GetCommonType(i + 1, VarType, RECORDTOK)
                          ...
                          if (Ident[IdentIndex].AllocElementType <> UNTYPETOK) and (Ident[IdentTemp].AllocElementType <> UNTYPETOK) and
                          ...
                          begin
                            ...
                            begin
                              ...
                              if (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType <> UNTYPETOK) and
                                (Ident[IdentIndex].NumAllocElements = 0) and (Ident[IdentTemp].DataType = POINTERTOK) and
                                (Ident[IdentTemp].AllocElementType <> UNTYPETOK) and (Ident[IdentTemp].NumAllocElements = 0) then
                                Error(k, 'Incompatible types: got "^' + InfoAboutToken(Ident[IdentTemp].AllocElementType) + '" expected "^' +
                        ...
                        begin
                          ...
                          case IndirectionLevel of
                            ASPOINTER:
                              if (Ident[IdentIndex].AllocElementType <> Ident[IdentTemp].AllocElementType) and not
                                (Ident[IdentIndex].DataType in [RECORDTOK, OBJECTTOK]) then
                                Error(k, 'Incompatible types: got "' + Types[Ident[IdentTemp].NumAllocElements].Field[0].Name
                                  + '" expected "^' + Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"');

                            ASPOINTERTOPOINTER:
                              if (Ident[IdentIndex].AllocElementType <> Ident[IdentTemp].AllocElementType) and not
                                (Ident[IdentTemp].DataType in [RECORDTOK, OBJECTTOK]) then
                                Error(k, 'Incompatible types: got "' + Types[Ident[IdentTemp].NumAllocElements].Field[0].Name
                                  + '" expected "^' + Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"');
                            else
                        ...
                        begin
                          ...
                          if ((Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType in
                            [RECORDTOK, OBJECTTOK])) or ((VarType = STRINGPOINTERTOK) and (ExpressionType = PCHARTOK))
                          then

                          else
                            if (VarType in [RECORDTOK, OBJECTTOK]) then
                              Error(i, 'Incompatible types: got "' + InfoAboutToken(ExpressionType) + '" expected "' +
                                Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"')
                            else
                              GetCommonType(i + 1, VarType, ExpressionType);
                  ...
                  if (Ident[IdentIndex].PassMethod <> VARPASSING) and (IndirectionLevel <> ASPOINTERTODEREFERENCE) and
                    (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].NumAllocElements = 0) and
                    (ExpressionType <> POINTERTOK) then
                  begin
                    ...
                    if (Ident[IdentIndex].AllocElementType in {IntegerTypes}OrdinalTypes) and
                      ...
                      begin
                        ...
                        if (ExpressionType in [PCHARTOK, STRINGPOINTERTOK]) and (Ident[IdentIndex].AllocElementType = CHARTOK) then
                          ...
                          Error(i + 1, 'Incompatible types: got "' + InfoAboutToken(ExpressionType) + '" expected "' +
                            Ident[IdentIndex].Name + '"');
                  ...
                  begin
                    ...
                    if Ident[IdentIndex].PassMethod = Ident[IdentTemp].PassMethod then
                      case IndirectionLevel of
                        ASPOINTER:
                          if (Tok[k + 1].Kind <> DEREFERENCETOK) and (Ident[IdentIndex].AllocElementType <>
                            Ident[IdentTemp].AllocElementType) and not (Ident[IdentTemp].DataType in [RECORDTOK, OBJECTTOK]) then
                            Error(k, 'Incompatible types: got "^' + Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "' +
                              Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"');
                    ...
                    if (Ident[IdentIndex].DataType = POINTERTOK) and (Ident[IdentIndex].AllocElementType in
                      [RECORDTOK, OBJECTTOK]) and (Ident[IdentIndex].PassMethod = Ident[IdentTemp].PassMethod) then
                    begin
                      ...
                      if yes and (ADDRESS = False) and (ExpressionType in [RECORDTOK, OBJECTTOK]) then
                        if (Ident[IdentTemp].DataType = POINTERTOK) and (Ident[IdentTemp].AllocElementType in
                          ...
                          Error(i, 'Incompatible types: got "^' +
                            Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "^' +
                            Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"')
                        else
                          Error(i, 'Incompatible types: got "' +
                            Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "^' +
                    ...
                    if (ExpressionType in [RECORDTOK, OBJECTTOK]) or ((ExpressionType = POINTERTOK) and
                      (Ident[IdentTemp].AllocElementType in [RECORDTOK, OBJECTTOK])) then
                    begin
                      ...
                      if IdentTemp > 0 then
                        ...
                        if Ident[IdentIndex].NumAllocElements <> Ident[IdentTemp].NumAllocElements then
                          ...
                          if (Ident[IdentIndex].NumAllocElements = 0) then
                            Error(i, 'Incompatible types: got "' +
                              Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "' +
                              InfoAboutToken(Ident[IdentIndex].DataType) + '"')
                          else
                            Error(i, 'Incompatible types: got "' +
                              Types[Ident[IdentTemp].NumAllocElements].Field[0].Name + '" expected "' +
                              Types[Ident[IdentIndex].NumAllocElements].Field[0].Name + '"');
                      ...
                      if (Ident[IdentIndex].DataType = RECORDTOK) and (Ident[IdentTemp].DataType = RECORDTOK) and
                        (Ident[IdentTemp].AllocElementTYpe = RECORDTOK) then
                      begin
       ...
       for j:=0 to RecordSize(IdentIndex)-1 do begin
        ...
        if j <> RecordSize(IdentIndex)-1 then asm65(#9'iny');
                    ...
                    begin
                      ...
                      if (Tok[k].Kind <> ADDRESSTOK) and (IndirectionLevel in [ASPOINTERTOARRAYORIGIN, ASPOINTERTOARRAYORIGIN2]) and
                        (Ident[IdentIndex].AllocElementType = STRINGPOINTERTOK) then
                      begin
                    ...
                    // dla PROC, FUNC -> Ident[GetIdent(Tok[k].Name^)].NumAllocElements -> oznacza liczbe parametrow takiej procedury/funkcji
                      ...
                      if (VarType in Pointers) and ((ExpressionType in Pointers) and (Tok[k].Kind = IDENTTOK)) and
                        (not (Ident[IdentIndex].AllocElementType in Pointers + [RECORDTOK, OBJECTTOK]) and not
                        (Ident[GetIdent(Tok[k].Name^)].AllocElementType in Pointers + [RECORDTOK, OBJECTTOK])) then
                      begin
                        ...
                        begin
                          ...
                          begin
                            ...
                            // perl
                            if Ident[IdentTemp].AllocElementType <> RECORDTOK then
                              if (j <> Integer(Elements(IdentTemp) {Ident[IdentTemp].NumAllocElements} *
                                DataSize[Ident[IdentTemp].AllocElementType])) then
                                if (Ident[IdentIndex].AllocElementType <> Ident[IdentTemp].AllocElementType) or
                                  ((Ident[IdentTemp].NumAllocElements <> Ident[IdentIndex].NumAllocElements_) and
                                  (Ident[IdentTemp].NumAllocElements_ = 0)) or ((Ident[IdentIndex].NumAllocElements <>
                                  Ident[IdentTemp].NumAllocElements_) and (Ident[IdentIndex].NumAllocElements_ = 0)) then
...

{
        ...
        ResetOpty;
                            ...
                            begin
                              ...
                              if (Ident[IdentIndex].NumAllocElements_ > 0) and
                                ...
                                (Ident[IdentIndex].NumAllocElements_ = Ident[IdentTemp].NumAllocElements_)) then
                              begin
                                ...
                                asm65(#9'lda <' + IntToStr(Ident[IdentIndex].NumAllocElements_ *
                                  DataSize[Ident[IdentIndex].AllocElementType]));
                                asm65(#9'sta @move.cnt');
                                asm65(#9'lda >' + IntToStr(Ident[IdentIndex].NumAllocElements_ *
                                  DataSize[Ident[IdentIndex].AllocElementType]));
                                asm65(#9'sta @move.cnt+1');
      ...
      begin
        ...
        if (SelectorType = ENUMTYPE) and (Tok[j].Kind = IDENTTOK) and
          (Ident[GetIdent(Tok[j].Name^)].Kind = FUNCTIONTOK) then
        begin
          ...
          if (SelectorType = ENUMTYPE) and (Tok[j].Kind = IDENTTOK) and (Ident[GetIdent(Tok[j].Name^)].Kind = TYPETOK) then
          begin
...
{$ENDIF}
      ...
      begin
        ...
        begin
          ...
          if IdentIndex > 0 then
            if not ((Ident[IdentIndex].Kind = VARIABLE) and (Ident[IdentIndex].DataType in OrdinalTypes +
              Pointers) {and (Ident[IdentIndex].AllocElementType = UNTYPETOK)}) then
  ...
  {$ENDIF}
                    ...
                    begin
                      ...
                      if DataSize[ActualParamType] > DataSize[Ident[IdentIndex].DataType] then
                        ActualParamType := Ident[IdentIndex].DataType;
                    ...
                    begin
                      ...
                      Push(Ident[IdentTemp].Value, ASPOINTER, {DataSize[Ident[IdentTemp].DataType]} DataSize[ActualParamType],
                        IdentTemp);
      ...
      ASSIGNFILETOK:
        if Tok[i + 1].Kind <> OPARTOK then
          ...
          begin
            ...
            if not ((Ident[IdentIndex].DataType in [FILETOK, TEXTFILETOK]) or
              (Ident[IdentIndex].AllocElementType in [FILETOK, TEXTFILETOK])) then
              iError(i + 2, IncompatibleTypeOf, IdentIndex);
        ...
        if Tok[i + 1].Kind <> OPARTOK then
          ...
          begin
            ...
            begin
              ...
              if (Ident[IdentIndex].DataType = TEXTFILETOK) or (Ident[IdentIndex].AllocElementType = TEXTFILETOK) then
                Error(i, 'Call by var for arg no. 1 has to match exactly: Got "' + InfoAboutToken(Ident[IdentIndex].DataType) +
                  '" expected "File"');
            ...
            begin
              ...
              if IdentIndex > 0 then
                ...
                begin
                  ...
                  if (Ident[IdentIndex].DataType in Pointers) and (Ident[IdentIndex].NumAllocElements > 0) and
                    (Ident[IdentIndex].AllocElementType = CHARTOK) then
                  begin     // string
                            ...
                            GenerateWriteString(Tok[i].Value, ASSHORTREAL)      // ShortReal argument
                              ...
                              GenerateWriteString(Tok[i].Value, ASHALFSINGLE)      // Half Single argument
                                ...
                                begin
                                  ...
                                  if (Ident[IdentIndex].AllocElementType = PROCVARTOK) then
                                  begin
                                    ...
                                    if (ExpressionType = STRINGPOINTERTOK) or (Ident[IdentIndex].Kind = FUNCTIONTOK) or
                                      ((ExpressionType = POINTERTOK) and (Ident[IdentIndex].DataType = STRINGPOINTERTOK)) then
      ...
      begin
       ...
       (Ident[IdentIndex].NumAllocElements=0)) or}
        ...
        if not (Ident[IdentIndex].idType in [PCHARTOK]) and (Ident[IdentIndex].DataType in Pointers) and
    ...
    asm65;
      ...
      begin
        ...
        begin
          ...
          if (ActualParamType = STRINGPOINTERTOK) and ((Ident[IdentIndex].DataType = POINTERTOK) and
            (Ident[IdentIndex].NumAllocElements = 0)) then
            ...
            case Ident[IdentIndex].Kind of
              ...
              VARIABLE: if Ident[IdentIndex].isAbsolute then
                begin    // ABSOLUTE = TRUE
                  ...
                  if (Ident[IdentIndex].PassMethod <> VARPASSING) and (Ident[IdentIndex].DataType in
                    [RECORDTOK, OBJECTTOK] + Pointers) and (Ident[IdentIndex].NumAllocElements > 0) then
                  begin
                  ...
                  begin
                    ...
                    begin
                      ...
                      if Ident[IdentIndex].DataType in [RECORDTOK, OBJECTTOK] then
                        asm65('adr.' + Ident[IdentIndex].Name + Value(True) + #9'; [' + IntToStr(RecordSize(IdentIndex)) +
                          '] ' + InfoAboutToken(Ident[IdentIndex].DataType))
                      else
                        ...
                        begin
                          ...
                          if (Ident[IdentIndex].NumAllocElements_ > 0) and not (Ident[IdentIndex].AllocElementType in
                            [RECORDTOK, OBJECTTOK]) then
                            asm65('adr.' + Ident[IdentIndex].Name + Value(True, True) + ' .array [' +
                              IntToStr(Ident[IdentIndex].NumAllocElements) + '] [' + IntToStr(Ident[IdentIndex].NumAllocElements_) +
                              ']' + mads_data_size)
                          else
                            asm65('adr.' + Ident[IdentIndex].Name + Value(True, True) + ' .array [' +
                              IntToStr(Elements(IdentIndex)) + ']' + mads_data_size);  // !!!!
...
{       FORWARDTOK: begin
  ...
  begin
    ...
    for TypeIndex := 1 to NumIdent do
      if (Ident[TypeIndex].AllocElementType = FORWARDTYPE) and (Ident[TypeIndex].Block =
        ...
        begin
          ...
          begin
            ...
            if (Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].DataType = POINTERTOK) and
              (Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].NumAllocElements > 0) then
            begin
              ...
              if Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].NumAllocElements shr 16 > 0 then
                NumAllocElements := (NumAllocElements *
                  (Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].NumAllocElements shr 16));

              NumAllocElements := NumAllocElements *
                DataSize[Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].AllocElementType];
              ...
              case Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].DataType of
                ...
                RECORDTOK: NumAllocElements := ObjectRecordSize(
                    Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].NumAllocElements);
                else
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if Ident[NumIdent].AllocElementType = UNTYPETOK then Ident[NumIdent].AllocElementType :=
...

{
  writeln(Types[Ident[BlockIdentIndex].ObjectIndex].Field[ParamIndex].Name,',',
    ...
    while Tok[i].Kind in [CONSTTOK, TYPETOK, VARTOK, LABELTOK, PROCEDURETOK, FUNCTIONTOK, PROGRAMTOK,
        USESTOK, LIBRARYTOK, EXPORTSTOK, CONSTRUCTORTOK, DESTRUCTORTOK, LINKTOK, UNITBEGINTOK,
        UNITENDTOK, IMPLEMENTATIONTOK, INITIALIZATIONTOK, IOCHECKON, IOCHECKOFF, LOOPUNROLLTOK,
        NOLOOPUNROLLTOK, PROCALIGNTOK, LOOPALIGNTOK, LINKALIGNTOK, INFOTOK, WARNINGTOK, ERRORTOK] do
    begin
            ...
            begin
              ...
              begin
                ...
                if Tok[j].StrLength > 255 then
                  ...
                  DefineIdent(i + 1, Tok[i + 1].Name^, CONSTANT, ConstValType, Tok[j].StrLength, CHARTOK,
                    ConstVal + CODEORIGIN, Tok[j].Kind);
              ...
              begin
                ...
                begin
                  ...
                  if Tok[i + 3].Kind = ARRAYTOK then j :=
                  ...
                  begin
                    ...
                    if (Ident[NumIdent].NumAllocElements in [0, 1]) and (open_array = False) then
                      ...
                      begin                  // const array of type = [ ]
                        ...
                        begin
                          j := ReadDataOpenArray(j + 2, NumStaticStrChars, AllocElementType, NumAllocElements,
                            True, Tok[j].Kind = PCHARTOK);
      ...
      begin
        ...
        repeat
          ...
          begin
            ...
            if IdType = ARRAYTOK then i := CompileType(i + 3, NestedDataType, NestedNumAllocElements,
              ...
              begin
                ...
                begin
                  ...
                  if (ConstVal < 0) or (ConstVal > $FFFFFF) then
                    Error(i, 'Range check error while evaluating constants (' + IntToStr(ConstVal) + ' must be between 0 and ' +
                      IntToStr($FFFFFF) + ')');
          ...
          begin
            ...
            begin
              ...
              if (VarType = POINTERTOK) and (AllocElementType = STRINGPOINTERTOK) and (NestedNumAllocElements > 0) and
                (NumAllocElements > 1) then
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    if (Tok[i].Kind = STRINGLITERALTOK) and (open_array = False) and (VarType = POINTERTOK) and
                      (AllocElementType = CHARTOK) then
           ...
           SaveToDataSegment(idx + j, ord( StaticStringData[ Tok[i].StrAddress - CODEORIGIN + j ] ), BYTETOK);
                      ...
                      if (Ident[NumIdent].NumAllocElements in [0, 1]) and (open_array = False) then
                        ...
                        begin                   // array of type = [ ]
                          ...
                          begin
                            i := ReadDataOpenArray(i, idx, Ident[NumIdent].AllocElementType, NumAllocElements,
                              False, Tok[i - 2].Kind = PCHARTOK);
                        ...
                        begin                    // array [] of type = ( )
                          ...
                          begin    // = 'string'
                            ...
                            i := ReadDataArray(i, idx, Ident[NumIdent].AllocElementType, Ident[NumIdent].NumAllocElements or
                              Ident[NumIdent].NumAllocElements_ shl 16, False, Tok[i - 2].Kind = PCHARTOK);
        ...
        begin
          ...
          if ForwardIdentIndex <> 0 then
            if not Ident[ForwardIdentIndex].IsUnresolvedForward or (Ident[ForwardIdentIndex].Block <>
              BlockStack[BlockStackTop]) or ((Tok[i].Kind = PROCEDURETOK) and (Ident[ForwardIdentIndex].Kind <> PROCEDURETOK)) or
          ...
          begin
            ...
            begin
              ...
              j := CompileBlock(i + 1, NumIdent, Ident[NumIdent].NumParams, IsNestedFunction, NestedFunctionResultType,
                NestedFunctionNumAllocElements, NestedFunctionAllocElementType);
            ...
            begin
              ...
              begin
                ...
                for ParamIndex := 1 to Ident[ForwardIdentIndex].NumParams do
                  if ((Ident[ForwardIdentIndex].Param[ParamIndex].Name <> Param[ParamIndex].Name) or
                    ...
                    Error(i, 'Function header ''' + Ident[ForwardIdentIndex].Name + ''' doesn''t match forward : ' +
                      Ident[ForwardIdentIndex].Param[ParamIndex].Name + ' <> ' + Param[ParamIndex].Name);
              ...
              j := CompileBlock(i + 3, ForwardIdentIndex, Ident[ForwardIdentIndex].NumParams, IsNestedFunction,
                Ident[ForwardIdentIndex].DataType, Ident[ForwardIdentIndex].NestedFunctionNumAllocElements,
              ...
              GenerateReturn(IsNestedFunction, Ident[ForwardIdentIndex].isInterrupt, Ident[ForwardIdentIndex].isInline,
  ...
  if target.id = ___a8 then begin
    ...
    for i := 0 to High(resArray) - 1 do
      if resArray[i].resStream then
        asm65(#9'.print ''$R ' + resArray[i].resName + ''',' + ''' ''' + ',' + '"''' + resArray[i].resFile +
          '''"' + ',' + ''' ''' + ',MAIN.@RESOURCE.' + resArray[i].resName + ',' + '''..''' + ',MAIN.@RESOURCE.' + resArray[i].resName + '.end-1');
