   ...
   function STA_BP2_(i: integer): Boolean;
   begin
     Result := (listing[i] = #9'sta :bp2') or (listing[i] = #9'sta :bp2+1')
   end;
   ...
   function SUB_BP2_Y(i: integer): Boolean;
   begin
   ...
   function SBC_BP2_Y(i: integer): Boolean;
   begin
